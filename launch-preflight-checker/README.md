...
`t.me/...?...startapp=...` может отдавать Telegram-обёртку, а не фактический DOM Mini App. Checker распознаёт такой URL и честно помечает ограничение. Для точной DOM-проверки лучше передать прямой **Web URL** страницы из NotiBot.
